 ...
 * java.util.ConcurrentModificationException; import java.util.Iterator; import
 * java.util.NavigableSet; import java.util.NoSuchElementException; import
 * java.util.Set; import java.util.SortedSet; import java.util.TreeSet;
 * 
 ...
 * 
 * @Test public void whenAddingElement_shouldAddElement() {
 * 
 * Set<String> treeSet = new TreeSet<>(); Set<String> treeSet2 = new
 ...
 *//**
	 ...
	 */
/*
 * @Test public void whenCheckingForElement_shouldSearchForElement() {
 * Set<String> treeSetContains = new TreeSet<>();
 * treeSetContains.add("String Added");
 * 
 * assertTrue(treeSetContains.contains("String Added")); }
 * 
 * @Test public void whenRemovingElement_shouldRemoveElement() { Set<String>
 * removeFromTreeSet = new TreeSet<>(); removeFromTreeSet.add("String Added");
 * 
 ...
 * 
 * @Test public void whenClearingTreeSet_shouldClearTreeSet() { Set<String>
 * clearTreeSet = new TreeSet<>(); clearTreeSet.add("String Added");
 * clearTreeSet.clear();
 * 
 * assertTrue(clearTreeSet.isEmpty()); }
 * 
 * @Test public void whenCheckingTheSizeOfTreeSet_shouldReturnThesize() {
 * Set<String> treeSetSize = new TreeSet<>(); treeSetSize.add("String Added");
 * 
 * assertEquals(1, treeSetSize.size()); }
 * 
 * @Test public void whenCheckingForEmptyTreeSet_shouldCheckForEmpty() {
 ...
 *//**
	 ...
	 */
/*
 * @Test public void whenIteratingTreeSet_shouldIterateTreeSetInAscendingOrder()
 * { System.out.println(
 ...
 * ); Set<String> treeSet = new TreeSet<>(); treeSet.add("First");
 * treeSet.add("Second"); treeSet.add("Third"); Iterator<String> itr =
 * treeSet.iterator(); while (itr.hasNext()) {
 * 
 * // itr.remove(); //java.lang.IllegalStateException
 * System.out.println(itr.next()); itr.remove();// OK }
 * System.out.println(treeSet); }
 * 
 * @Test public void
 * whenIteratingTreeSet_shouldIterateTreeSetInDescendingOrder() {
 * TreeSet<String> treeSet = new TreeSet<>(); treeSet.add("First");
 * treeSet.add("Second"); treeSet.add("Third"); Iterator<String> itr =
 * treeSet.descendingIterator(); while (itr.hasNext()) {
 ...
 *//**
	 ...
	 */
/*
 * @Test public void whenModifyingTreeSetWhileIterating_shouldThrowException() {
 ...
 * Set<String> treeSet = new TreeSet<>(); treeSet.add("First");
 * treeSet.add("Second"); treeSet.add("Third"); Iterator<String> itr =
 * treeSet.iterator(); while (itr.hasNext()) { itr.next();
 ...
 * Set<String> treeSet = new TreeSet<>(); treeSet.add("First");
 * treeSet.add("Second"); treeSet.add("Third"); Iterator<String> itr =
 * treeSet.iterator(); while (itr.hasNext()) { String element = itr.next(); if
 * (element.equals("Second")) itr.remove(); }
 * 
 * System.out.println(treeSet); assertEquals(2, treeSet.size()); }
 * 
 *//**
	 ...
	 */
/*
 * @Test public void whenCheckingFirstElement_shouldReturnFirstElement() {
 * TreeSet<String> treeSet = new TreeSet<>(); treeSet.add("First");
 * 
 * assertEquals("First", treeSet.first());
 * 
 * Assertions.assertThrows(NoSuchElementException.class, () -> { Set<String>
 * treeSet2 = new TreeSet<>(); assertEquals("First", ((TreeSet<String>)
 * treeSet2).first()); }); }
 * 
 * @Test public void whenCheckingLastElement_shouldReturnLastElement() {
 * TreeSet<String> treeSet = new TreeSet<>(); treeSet.add("First");
 * treeSet.add("Last");
 * 
 ...
 * SortedSet<Integer> treeSet = new TreeSet<>(); treeSet.add(1); treeSet.add(2);
 * treeSet.add(3); treeSet.add(4); treeSet.add(5); treeSet.add(6);
 * 
 * Set<Integer> expectedSet = new TreeSet<>(); expectedSet.add(2);
 * expectedSet.add(3); expectedSet.add(4); expectedSet.add(5);
 * 
 * Set<Integer> subSet = treeSet.subSet(2, 6); System.out.println(subSet);
 * 
 * assertEquals(expectedSet, subSet); assertNotSame(expectedSet, subSet);
 * org.junit.Assert.assertEquals(expectedSet, subSet); }
 * 
 * @Test public void whenUsingHeadSet_shouldReturnHeadSetElements() {
 * SortedSet<Integer> treeSet = new TreeSet<>(); treeSet.add(1); treeSet.add(2);
 * treeSet.add(3); treeSet.add(4); treeSet.add(5); treeSet.add(6);
 * 
 ...
 * 
 * @Test public void whenUsingTailSet_shouldReturnTailSetElements() {
 * NavigableSet<Integer> treeSet = new TreeSet<>(); treeSet.add(1);
 * treeSet.add(2); treeSet.add(3); treeSet.add(4); treeSet.add(5);
 * treeSet.add(6);
 * 
 ...
 *//**
	 ...
	 * 
	 *//*
		 * @Test public void whenAddingNullToNonEmptyTreeSet_shouldThrowException() {
		 * Assertions.assertThrows(NullPointerException.class, () -> { System.out
		 * .println("Before Java 7, it was possible to add null elements to an empty TreeSet.\r\n"
		 * + "	 * \r\n" +
		 * "	 * However, that was considered a bug. Therefore, TreeSet no longer supports the\r\n"
		 * + "	 * addition of null."); Set<String> treeSet = new TreeSet<>();
		 * treeSet.add("First"); treeSet.add(null); });
		 * 
		 * System.out.println(
		 ...
		 * 
		 * Comparator<Element> comparator = (ele1, ele2) -> { return
		 * ele1.getId().compareTo(ele2.getId()); };
		 * 
		 * @Test public void whenUsingComparator_shouldSortAndInsertElements() {
		 * Set<Element> treeSet = new TreeSet<>(comparator); Element ele1 = new
		 * Element(); ele1.setId(100); Element ele2 = new Element(); ele2.setId(200);
		 * 
		 * treeSet.add(ele1); treeSet.add(ele2);
		 * 
		 * System.out.println(treeSet); }
		 * 
		 * }
