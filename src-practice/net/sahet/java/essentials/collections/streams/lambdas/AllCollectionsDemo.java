...
class SortingLists {
	public static void main(String[] args) {
		...
		list = new ArrayList<>(Arrays.asList(new Car("Citroen C1", "ABC 164521", 5),
				new Car("Volvo V40", "XYZ 201845", 5), new Car("Citroen C1", "ABC 164521", 4),
				new Car("Dodge", "KLM 845990", 2), new Car("Dodge Ram", "KLM 845990", 3)));
